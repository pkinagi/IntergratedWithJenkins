...
public class SSDMixedUse extends BaseClass 
{
...
@BeforeTest(description = "To Lauch SSD Selector Tool Site And To Select Mixed Use Workloads")
	...
	@Test(priority = 7, description = "To Verify To Select Mixed workloads")
	public void ToVerifyToSelectMixedWorkloads()
	{
	...
	@Test(priority = 10, description = "To Select Mixed Use Workloads from Workload Page")
	public void ToVerifyToSelectMixedUseWorkload()
	{
		// Select All Mixed Intensive Workloads
		ssdWorkload.SelectMixedALL();
	...
	public void ToVerifySSDTypeIsSelected()
	{
		...
		Assert.assertTrue(ssdSSDType.MixedUseSelected(), "Mixed Use Selected");
		
	}
	
	@Test(priority = 13, description = "To Verify Mixed Use Is Selected Click on Back Btn in SSD Page")
	public void ToVerifyMixedUseeSelected()
	{
		// Click Back Btn in SSD Page
		ssdSSDType.SSDBackBtn();
		
		// To Check Selected Mixed Use Workloads are Retained
		Assert.assertTrue(ssdWorkload.VerifyMixedUseWorkloadsSelected(), "Mixed Use Workloads Are Selected");
	...
	public void ToVerifyServerPageLabels()
	{
		...
		//Capacity Label
		ssdServertype.MixedMaximumCapacityValue();
	...
	public void ToSelectServerTypeServerModel()
	{
		...
		ssdServertype.MixedUseSelectedServerType();
		// For Selecting the Server Model
		ssdServertype.MixedUseSelectedServerModel();
	}
	...
	public void ToVerifyInterfacePage()
	{
	 ...
	 @Test(priority = 22, description = "To Verify Selected Values retained in SSD Page on Click on Back Btn in Server Type Page")
		public void ToVerifySSDValues()
		{
			...
			ssdServertype.MixedUseSelectedRetainedCheck();
	...
	public void ToVerifyFormFactorOptions()
	{
		...
		if(FFPageLoad == true)
		{
			...
			Assert.assertTrue(ssdFormfactorType.MixedUseSelectFormFactorType(),"Select All Option Is Selected In FormFactor Page");
		}
	}
	...
	public void ToEditFormFactionOptions()
	{
		...
		Assert.assertFalse(ssdFormfactorType.MixedUseEditFormFactorOption(), "Select All Option is not Selected");
	...
	public void ToVerifyEditedOptionRetained()
	{
		...
		Assert.assertTrue(ssdFormfactorType.MixedUseFormFactorAsItIs(), "Select All Option is Selected");
	...
	@Test(priority = 33, description = "SSD Workload Only Mixed Use Workload should be selected")
	public void ToVerifyWorkloadSelectedOptionDisplayed()
	{
		// Read Intensive Workload Is Selected
		Assert.assertTrue(ssdResult.SSDResMixedUse.isSelected(), "Mixed Use Is Selected");
	}
	...
	{
		Assert.assertTrue(ssdResult.MixedUseSSDFormFactorTypeSelected(), "Form Factor Options are Selected");
	}
	...
	public void ToVerifySelectedServerTypeDisplayed()
	{
		...
		ssdResult.MixedUseSelectedResultPageServerType();
		// To Check the Server Model in Result Page
		ssdResult.MixedUseSelectedResultPageServerModel();
		// To Check the Max Capacity Slider
		ssdResult.ResultPageMixedUseSSDCapacityMaxSliderText();
	}
	...
	public void ToVerifySSDResultsDisplayedBasedOnServerType()
	{
		...
		ReadResultDisplay = ReadSSDs.until(ExpectedConditions.textToBePresentInElement(ssdResult.SSDResResultDisplayLink, Prop.getProperty("MixedUseSSDsResultsBasedOnServerType")));
		if(ReadResultDisplay == true)
		{
			String ActualReadSSDs = Prop.getProperty("MixedUseSSDsResultsBasedOnServerType");
			String ExpectedReasSSDs = ssdResult.SSDResResultDisplayLink.getText();
			System.out.println("Mixed Use SSDs Results Based Upon the Selected Server Type and Server Model :- " + ExpectedReasSSDs);
	...
	@Test(priority = 43, description = "To Check All Mixed SSD Are Displayed ")
	public void ToVerifyAllMixedSSDsDisplayedOnSelectServerType()
	{
		...
		boolean ReadResultDisplay = ssdResult.SSDResResultDisplayLink1;
		ReadResultDisplay = ReadSSDs.until(ExpectedConditions.textToBePresentInElement(ssdResult.SSDResResultDisplayLink, Prop.getProperty("MixedSSDs")));
		if(ReadResultDisplay == true)
		{
			String ActualReadSSDs = Prop.getProperty("MixedSSDs");
			String ExpectedReasSSDs = ssdResult.SSDResResultDisplayLink.getText();
			System.out.println("Mixed Intensive SSDs :- " + ExpectedReasSSDs);
			Assert.assertEquals(ActualReadSSDs, ExpectedReasSSDs);
		}
		else
		{
	...
	public void ToVerifyOnlyMixedUsSSDsDisplayed()
	{
		Assert.assertTrue(ssdResult.SSDOnlyMixedUseResults.isDisplayed(), "Mixed Use Displayed");
	}
