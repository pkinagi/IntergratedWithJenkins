...
public class SSDReadAll extends BaseClass
{
	public SSDReadAll()
	{
		super();
	...
	@BeforeTest(description = "To Lauch SSD Selector Tool Site And To Select Read Intensive Workloads")
	...
	public void ToVerifyDisplayOfWorkloads()
	{
		...
		//Assert.assertTrue(ssdWorkload.CoordinatesofReadIntensiveWorkloads(), "Read Intensive Workload Column Is Displayed At 2nd");
	}
	...
	@Test(priority = 7, description = "To Verify To Select Read Intensive workloads")
	public void ToVerifyToSelectReadIntensiveWorkload()
	{
		// Read Intensive Workloads Are Selected
	...
	@Test(priority = 10, description = "To Select Read Intensive Workloads from Workload Page")
	public void ToVerifyToSelectReadIntensive()
	{
		// Select All Read Intensive Workloads
		ssdWorkload.SelectReadALL();
	...
	public void ToVerifySSDTypeIsSelected()
	{
		...
		// To Verify Other SSDs are not Selected
		//Assert.assertFalse(ssdSSDType.ReadWorkloadSelected(), "Other SSDs Should Not Be Selected");
		
		
	}
	
	@Test(priority = 13, description = "To Verify Read Intensive Is Selected Click on Back Btn in SSD Page")
	public void ToVerifyReadIntensiveSelected()
	{
		// Click Back Btn in SSD Page
		ssdSSDType.SSDBackBtn();
		
		// To Check Selected Read Workloads are Retained
		Assert.assertTrue(ssdWorkload.VerifyAllReadIntensiveSelected(), "Read Intensive Workloads Are Selected");
	...
	public void ToSelectServerTypeServerModel()
	{
		...
		ssdServertype.ReadSelectedServerType();
		// For Selecting the Server Model
		ssdServertype.ReadSelectedServerModel();
	}
	
	@Test(priority = 19, description = "To Verify Capacity Maximum to Minimum")
	public void ToVerifyCapacityAlert()
	{
		WebDriverWait CapacityAlertLoad = new WebDriverWait(driver, 2);
	...
	public void ToVerifyInterfacePage()
	{
	 ...
	 @Test(priority = 22, description = "To Verify Selected Values retained in SSD Page on Click on Back Btn in Server Type Page")
		public void ToVerifySSDValues()
		{
			...
			ssdServertype.ReadSelectedRetainedCheck();
	...
	public void ToVerifyInterfaceLabels()
	{
		...
		Assert.assertTrue(ssdInterface.ReadSelectInterfaceOptions(), "Interface Options Are AutoSelected");
	}
	...
	public void ToVerifyFormFactorOptions()
	{
		...
		Assert.assertTrue(ssdFormfactorType.ReadSelectFormFactorType(),"Select All Option Is Selected In FormFactor Page");
	}
	...
	public void ToEditFormFactionOptions()
	{
		...
		Assert.assertFalse(ssdFormfactorType.ReadEditFormFactorOption(), "Select All Option is not Selected");
	...
	public void ToVerifyEditedOptionRetained()
	{
		...
		Assert.assertTrue(ssdFormfactorType.ReadFormFactorAsItIs(), "Select All Option is Selected");
	...
	{
		// Read Intensive Workload Is Selected
		Assert.assertTrue(ssdResult.SSDResReadIntensive.isSelected(), "Read Intensive Is Selected");
	}
	
	@Test(priority = 34, description = "SSD Intenface Options Selected")
	public void ToVerifySelectedInterfaceOptionsDisplayed()
	{
		Assert.assertTrue(ssdResult.SSDIntensiveTypeSelected(), "Interface Options are Selected");
	}
	
	@Test(priority = 35, description = "SSD Form Factor Options Selected")
	public void ToVerifySelectedFormFactorDisplayed()
	{
		Assert.assertTrue(ssdResult.SSDFormFactorTypeSelected(), "Form Factor Options are Selected");
	}
	...
	public void ToVerifySelectedServerTypeDisplayed()
	{
		...
		ssdResult.ReadSelectedResultPageServerType();
		// To Check the Server Model in Result Page
		ssdResult.ReadSelectedResultPageServerModel();
	...
	public void ToVerifySSDResultsDisplayedBasedOnServerType()
	{
		...
		WebDriverWait ReadSSDs = new WebDriverWait(driver,5);
		boolean ReadResultDisplay = ssdResult.SSDResResultDisplayLink1;
		ReadResultDisplay = ReadSSDs.until(ExpectedConditions.textToBePresentInElement(ssdResult.SSDResResultDisplayLink, Prop.getProperty("ReadSSDsResultsBasedOnServerType")));
		if(ReadResultDisplay == true)
		{
			String ActualReadSSDs = Prop.getProperty("ReadSSDsResultsBasedOnServerType");
			String ExpectedReasSSDs = ssdResult.SSDResResultDisplayLink.getText();
			System.out.println("Read Intensive SSDs Results Based Upon Selected Server Type and Server Model :- " + ExpectedReasSSDs);
			Assert.assertEquals(ActualReadSSDs, ExpectedReasSSDs);
		}
		else
		{
	...
	@Test(priority = 43, description = "To Check All Read SSD Are Displayed ")
	public void ToVerifyAllReadSSDsDisplayedOnSelectServerType()
	{
		...
		WebDriverWait ReadSSDs = new WebDriverWait(driver,10);
		boolean ReadResultDisplay = ssdResult.SSDResResultDisplayLink1;
		ReadResultDisplay = ReadSSDs.until(ExpectedConditions.textToBePresentInElement(ssdResult.SSDResResultDisplayLink, Prop.getProperty("ReadSSDs")));
		if(ReadResultDisplay == true)
		{
			String ActualReadSSDs = Prop.getProperty("ReadSSDs");
			String ExpectedReasSSDs = ssdResult.SSDResResultDisplayLink.getText();
			System.out.println("Read Intensive SSDs :- " + ExpectedReasSSDs);
			Assert.assertEquals(ActualReadSSDs, ExpectedReasSSDs);
		}
		else
		{
	...
	//To Check the Excel file Download For Individual SSDs
